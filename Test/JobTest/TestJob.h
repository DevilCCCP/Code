...
DefineDbClassS(TestJob);

class TestJob: public DbItemT<qint64>
{
public:
  QString    Name;
  QString    Descr;
...
public:
  TestJob(): DbItemT<qint64>(), IsActive(true), Priority(0), Iter(0), IterEnd(0), Done(0), Fail(0) { }
  /*override */virtual ~TestJob() { }
};

class TestJobTable: public DbTableT<qint64, TestJob>
{
  qint64 mCounter;
