...
DefineClassS(CarDetection);
DefineClassS(CarTracker);

class CarMotion: public AnalyticsB
{
  CarDetectionS       mCarDetection;
  CarTrackerS         mCarTracker;
