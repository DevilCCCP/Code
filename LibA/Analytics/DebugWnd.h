...
public:
  ...
  /*new */virtual void DrawWindow(const char* data, EImageType imageType, bool save, int width, int height, int stride, const char *objData = nullptr, int objSize = 0) = 0;
...
public:
  ...
  void DrawWindow(int index, const QString& caption, EImageType imageType, bool save, const char* data, int stride = 0, const char* objData = nullptr, int objSize = 0);
